...
export const upsertManagedUser = async (input: UpsertManagedUserInput): Promise<void> => {
...
export const setManagedUserActive = async (
  ...
  await usersCollection().doc(String(userId)).set(
    {
...
export const listActiveManagedUsers = async (chatId?: string): Promise<ManagedUser[]> => {
